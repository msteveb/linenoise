...
all:  linenoise-noutf8-example linenoise-example

linenoise-noutf8-example: linenoise.h linenoise-ship.c linenoise-win32.c example.c
	$(CC) $(CFLAGS) -o $@ linenoise-ship.c example.c

linenoise-example: linenoise.h linenoise-ship.c linenoise-win32.c
	$(CC) $(CFLAGS) -DUSE_UTF8 -o $@ linenoise-ship.c example.c

clean:
	rm -f linenoise-noutf8-example linenoise-example linenoise-ship.c linenoise-test *.o
...
# - If you never want to support utf-8, you can omit utf8.c
