...
static const int wideCharTableSize = sizeof(wideCharTable) / sizeof(wideCharTable[0]);

static int combiningCharTable[] = {
...
static const int combiningCharTableSize = sizeof(combiningCharTable) / sizeof(combiningCharTable[0]);

/* Check if the code is a wide character
 */
static int isWideChar(int cp) {
    int i;
 ...
 */
static int isCombiningChar(int cp) {
    int i;
